...
import com.example.qrscanner.feature.tabs.create.CreateBarcodeActivity
...
class CreateQrCodeAllActivity : BaseActivity() {
    ...
    private fun handleButtonsClicked() {
        ...
        button_upi.setOnClickListener { CreateBarcodeActivity.start(this, BarcodeFormat.QR_CODE, BarcodeSchema.UPI) }
